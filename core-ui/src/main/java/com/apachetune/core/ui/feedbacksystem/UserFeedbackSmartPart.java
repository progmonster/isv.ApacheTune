...
public class UserFeedbackSmartPart extends JDialog implements UserFeedbackView {
    ...
    private final ResourceBundle resourceBundle =
            ResourceManager.getInstance().getResourceBundle(UserFeedbackSmartPart.class);
...
// call onCancel() on ESCAPE
        ...
        lblUserMessage.setText(resourceBundle.getString("userFeedbackSmartPart.userMessageLabel"));
        lblUserEmail.setText(resourceBundle.getString("userFeedbackSmartPart.userEmailLabel"));
        lblCaption.setText(resourceBundle.getString("userFeedbackSmartPart.description"));

        buttonOK.setText(resourceBundle.getString("userFeedbackSmartPart.buttonOkCaption"));
        buttonCancel.setText(resourceBundle.getString("userFeedbackSmartPart.buttonCancelCaption"));
    }

    @Override
    public final void initialize(UIWorkItem workItem) {
        setTitle(resourceBundle.getString("userFeedbackSmartPart.dialogTitle"));
...
// add your code here if necessary
    ...
    private void $$$setupUI$$$() {
        ...
        lblCaption.setWrapStyleWord(true);
        panel3.add(lblCaption,
                new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
        ...
        panel4.add(panel5, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        lblUserEmail.setText("Your email (optional):");
        panel5.add(lblUserEmail, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
        ...
        lblUserMessage.setText("Your message:");
        panel4.add(lblUserMessage,
        ...
        lblUserEmail.setLabelFor(txtEmail);
    }
