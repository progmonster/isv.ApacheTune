...
public final class Constants {
    public static final String CORE_UI_WORK_ITEM = "CORE_UI_WORK_ITEM";
    ...
    public static final String MAIN_FRAME_TOP_PERSISTED = "MAIN_FRAME_TOP_PERSISTED";

    public static final String MAIN_FRAME_WIDTH_PERSISTED = "MAIN_FRAME_WIDTH_PERSISTED";

    public static final String MAIN_FRAME_HEIGHT_PERSISTED = "MAIN_FRAME_HEIGHT_PERSISTED";

    public static final String HELP_HELP_TOPICS_ACTION = "HELP_HELP_TOPICS_ACTION";
    
    public static final String HELP_SUBMIT_FEEDBACK_ACTION = "HELP_SUBMIT_FEEDBACK_ACTION";
    
    public static final String HELP_REGISTER_ACTION = "HELP_REGISTER_ACTION";
    ...
    public static final String PRINT_ACTION_GROUP = "PRINT_ACTION_GROUP";

    public static final String UNDO_REDO_ACTION_GROUP = "UNDO_REDO_ACTION_GROUP";

    public static final String EDIT_ACTION_GROUP = "EDIT_ACTION_GROUP";

    public static final String FEEDBACK_ACTION_GROUP = "FEEDBACK_ACTION_GROUP";

    public static final String HELP_ACTION_GROUP = "HELP_ACTION_GROUP";
    
    public static final String SERVER_REOPEN_SERVER_ACTION = "SERVER_REOPEN_SERVER_ACTION";

    public static final String SERVER_REOPEN_SERVER_EVENT = "SERVER_REOPEN_SERVER_EVENT";
    ...
    public static final String SAVE_FILE_STATUS = "SAVE_FILE_STATUS";
    
    public static final String CORE_UI_ACTION_GROUP = "CORE_UI_ACTION_GROUP";
    
    public static final String OBJECT_TREE_TOOL_WINDOW = "Object tree";

    public static final String FILE_SAVE_ALL_ACTION = "FILE_SAVE_ALL_ACTION";

    public static final String CLIPBOARD_ACTION_GROUP = "CLIPBOARD_ACTION_GROUP";
