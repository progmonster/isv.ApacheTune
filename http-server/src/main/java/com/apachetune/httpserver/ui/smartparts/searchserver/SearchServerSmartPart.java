...
import static com.apachetune.core.utils.Utils.*;
import com.apachetune.httpserver.impl.*;
import static com.apachetune.httpserver.ui.smartparts.searchserver.SourceTableModel.*;
...
// call onCancel() on ESCAPE
    ...
    public void initialize(WorkItem workItem) {
        ...
        sourceTableScrollPaneSize.setSize(sourceTableScrollPaneSize.getWidth(), sourceTable.getRowHeight() *
                (sourceTable.getRowCount() + 1 + 1)); // getRowCount() + header row and one blank row.
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(stopSearchButton, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        searchProgressBar = new JProgressBar();
        searchProgressBar.setIndeterminate(false);
        searchProgressBar.setOpaque(true);
        searchProgressBar.setString("");
        searchProgressBar.setStringPainted(true);
        panel3.add(searchProgressBar, new GridConstraints(0, 2, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel3.add(currentSearchLabel, new GridConstraints(1, 0, 1, 5, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(-1, 20), null, null, 0, false));
        ...
        contentPane.add(sourceTableScrollPane, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        sourceTable = new SourceTable();
        sourceTable.setVisible(false);
        sourceTableScrollPane.setViewportView(sourceTable);
        final JScrollPane scrollPane1 = new JScrollPane();
        contentPane.add(scrollPane1, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
